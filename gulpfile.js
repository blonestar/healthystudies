 ...
 */
 ...
 var url = 'http://healthystudies.dev';
...
gulp.task('build', function(cb) {
 	runSequence('styles', 'scriptsJs', 'cleanup', 'buildZip','cleanupFinal', cb);
});
...
gulp.task('deploy', function() {
  ...
  return gulp.src( globs, { base: '.', buffer: false } )
    .pipe( conn.newer( '/public_html/healthystudies.com/wp-content/themes/healthystudies' ) ) // only upload newer files
    .pipe( conn.dest( '/public_html/healthystudies.com/wp-content/themes/healthystudies' ) );
});
